...
First, we make a connection by following the instructions they offer, as shown below^[In the R code that is included, for each function it is indicated by the prefix the package where it is defined.].
