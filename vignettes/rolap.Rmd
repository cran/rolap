...
To do this, the functions `get_dimension_attribute_names()` and `get_measure_names()` are available to consult the current names, and `set_dimension_attribute_names()` and `set_measure_names()` to change them if necessary.
